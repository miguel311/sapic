...
3-) Crear un Ambiente Virtual:
    ...
    Salir del modo root y crear el ambiente en la carpeta donde se encuentre ubicado:

    $ virtualenv --python=/usr/bin/python3 sapic

4-) Instalar los requerimientos del proyecto 

    Para activar el ambiente virtual SAPIC ejecute el siguiente comando dentro del entorno virtual creado anteriomente llamado sapic :
...
si presenta problemas con pillow instalar
...
antes de hacer las migraciones es bueno agregar en /sapic/sapic/settings_default.py en la linea 40 otro elemento que es 'organizaciones',

	tambien se tiene que configurar la base de datos en postgres con usuario y clave y se cambia de nombre 'settings_default.py' a 'settings.py'

hacer las migraciones una a una de las PROJECT_APPS.
